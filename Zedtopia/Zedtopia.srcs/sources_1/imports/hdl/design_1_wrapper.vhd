...
--Date        : Sun Dec 17 12:01:04 2017
--Host        : Motoko running 64-bit Ubuntu 16.04.3 LTS
...
design_1_i: component design_1
     port map (
      B_Pin(3 downto 0) => B_Pin(3 downto 0),
      ...
      G_Pin(3 downto 0) => G_Pin(3 downto 0),
      H_Sync => H_Sync,
      R_Pin(3 downto 0) => R_Pin(3 downto 0),
      V_Sync => V_Sync,
      pix_clk => pix_clk,
      pix_data(7 downto 0) => pix_data(7 downto 0),
      pix_fval => pix_fval,
      pix_lval => pix_lval,
      sclk_O => sclk_O,
      sdata_I => sdata_I,
