...
set_property PACKAGE_PIN Y11 [get_ports {pix_data[0]}]
set_property PACKAGE_PIN AA11 [get_ports {pix_data[1]}]
set_property PACKAGE_PIN Y10 [get_ports {pix_data[2]}]
set_property PACKAGE_PIN AA9 [get_ports {pix_data[3]}]
set_property PACKAGE_PIN AB11 [get_ports {pix_data[4]}]
set_property PACKAGE_PIN AB10 [get_ports {pix_data[5]}]
set_property PACKAGE_PIN AB9 [get_ports {pix_data[6]}]
set_property PACKAGE_PIN AA8 [get_ports {pix_data[7]}]
...
set_property PACKAGE_PIN W12 [get_ports pix_fval]
set_property PACKAGE_PIN W11 [get_ports pix_lval]
set_property PACKAGE_PIN V10 [get_ports pix_clk]
set_property PACKAGE_PIN W8 [get_ports xclk]
set_property PACKAGE_PIN V9 [get_ports sdata]; 
...
# VGA Output - Bank 33
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN Y21 [get_ports {B_Pin[0]}]
set_property PACKAGE_PIN Y20 [get_ports {B_Pin[1]}]
set_property PACKAGE_PIN AB20 [get_ports {B_Pin[2]}]
set_property PACKAGE_PIN AB19 [get_ports {B_Pin[3]}]
set_property PACKAGE_PIN AB22 [get_ports {G_Pin[0]}]
set_property PACKAGE_PIN AA22 [get_ports {G_Pin[1]}]
set_property PACKAGE_PIN AB21 [get_ports {G_Pin[2]}]
set_property PACKAGE_PIN AA21 [get_ports {G_Pin[3]}]
set_property PACKAGE_PIN AA19 [get_ports H_Sync]
set_property PACKAGE_PIN V20 [get_ports {R_Pin[0]}]
set_property PACKAGE_PIN U20 [get_ports {R_Pin[1]}]
set_property PACKAGE_PIN V19 [get_ports {R_Pin[2]}]
set_property PACKAGE_PIN V18 [get_ports {R_Pin[3]}]
...
create_clock -period 10.000 -name sysClock -waveform {0.000 5.000} [get_ports -filter { NAME =~  "sys_clock*" && DIRECTION == "IN" }]

create_clock -period 40.000 -name pix_clk -waveform {0.000 20.000} [get_ports -filter { NAME =~  "pix_clk*" && DIRECTION == "IN" }]
